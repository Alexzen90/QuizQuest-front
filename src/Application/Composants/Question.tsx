        ...
        <div className="mb-6 w-2/3 flex flex-col">
            ...
            <div className='flex flex-col items-center'>
              <button
                  ...
                  className="mt-4 p-2 w-2/3 text-xl bg-sky-600 text-white rounded hover:bg-blue-700"
                  >
                  Valider
              </button>
              {isCorrect !== null && (
                <div className={`w-1/2 mt-4 p-2 text-center ${isCorrect ? 'bg-green-500' : 'bg-red-500'} text-white rounded`}>
